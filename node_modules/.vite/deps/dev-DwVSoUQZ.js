//#region node_modules/.pnpm/solid-js@1.9.14/node_modules/solid-js/dist/dev.js
...
function enqueue(taskQueue$1, task) {
	function findIndex() {
		let m = 0;
		let n = taskQueue$1.length - 1;
		while (m <= n) {
			const k = n + m >> 1;
			const cmp = task.expirationTime - taskQueue$1[k].expirationTime;
			if (cmp > 0) m = k + 1;
			else if (cmp < 0) n = k - 1;
			else return k;
		}
	...
	taskQueue$1.splice(findIndex(), 0, task);
}
...
function children(fn) {
	...
	const memo = createMemo(() => resolveChildren(children$1()), void 0, { name: "children" });
	memo.toArray = () => {
		const c = memo();
...
function enableExternalSource(factory, untrack$1 = (fn) => fn()) {
	if (ExternalSourceConfig) {
		...
		ExternalSourceConfig = {
			...
			untrack: (fn) => oldUntrack(() => untrack$1(fn))
		};
...
function observable(input) {
	return {
		subscribe(observer) {
			...
			const dispose$1 = createRoot((disposer) => {
				createEffect(() => {
					const v = input();
					untrack(() => handler(v));
				});
			...
			if (getOwner()) onCleanup(dispose$1);
			return { unsubscribe() {
				dispose$1();
			} };
		},
...
function SuspenseList(props) {
	...
	const resolved = createMemo((prev) => {
		...
		if (reveal === "together") {
			const all = reg.every((inFallback$1) => !inFallback$1());
			const res$1 = reg.map(() => ({
				showContent: all && showContent,
				showFallback
			}));
			res$1.inFallback = !all;
			return res$1;
		}
		let stop = false;
	...
	return createComponent(SuspenseListContext.Provider, {
		value: { register: (inFallback) => {
			let index;
			setRegistry((registry$1) => {
				index = registry$1.length;
				return [...registry$1, inFallback];
			});
...
//#endregion
export { useContext as $, enableExternalSource as A, mergeProps as B, createReaction as C, createSelector as D, createRoot as E, getListener as F, onMount as G, on as H, getOwner as I, runWithOwner as J, requestCallback as K, indexArray as L, enableScheduling as M, equalFn as N, createSignal as O, from as P, untrack as Q, lazy as R, createMemo as S, createResource as T, onCleanup as U, observable as V, onError as W, splitProps as X, sharedConfig as Y, startTransition as Z, createComponent as _, ErrorBoundary as a, createDeferred as b, Match as c, SuspenseList as d, useTransition as et, Switch as f, children as g, catchError as h, DEV as i, enableHydration as j, createUniqueId as k, Show as l, cancelCallback as m, $PROXY as n, For as o, batch as p, resetErrorBoundaries as q, $TRACK as r, Index as s, $DEVCOMP as t, Suspense as u, createComputed as v, createRenderEffect as w, createEffect as x, createContext as y, mapArray as z };
//# sourceMappingURL=dev-DwVSoUQZ.js.map