import { E as createRoot, I as getOwner, J as runWithOwner, O as createSignal, Q as untrack, S as createMemo, U as onCleanup, X as splitProps, Y as sharedConfig, j as enableHydration, t as $DEVCOMP, w as createRenderEffect, x as createEffect } from "./dev-DwVSoUQZ.js";

//#region node_modules/.pnpm/solid-js@1.9.14/node_modules/solid-js/web/dist/dev.js
...
function clearDelegatedEvents(document$1 = window.document) {
	if (document$1[$$EVENTS]) {
		for (let name of document$1[$$EVENTS].keys()) document$1.removeEventListener(name, eventHandler);
		delete document$1[$$EVENTS];
	}
}
...
//#endregion
export { template as $, isDev as A, setAttributeNS as B, getNextElement as C, hydrate as D, getPropAlias as E, renderToString as F, ssr as G, setProperty as H, renderToStringAsync as I, ssrElement as J, ssrAttribute as K, resolveSSRNode as L, memo as M, render as N, innerHTML as O, renderToStream as P, style as Q, runHydrationEvents as R, getHydrationKey as S, getNextMatch as T, setStyleProperty as U, setBoolAttribute as V, spread as W, ssrSpread as X, ssrHydrationKey as Y, ssrStyle as Z, clearDelegatedEvents as _, Dynamic as a, dynamicProperty as b, Portal as c, SVGElements as d, use as et, SVGNamespace as f, className as g, classList as h, DelegatedEvents as i, isServer as j, insert as k, Properties as l, assign as m, ChildProperties as n, Hydration as o, addEventListener as p, ssrClassList as q, DOMElements as r, NoHydration as s, Aliases as t, voidFn as tt, RequestContext as u, createDynamic as v, getNextMarker as w, escape as x, delegateEvents as y, setAttribute as z };
//# sourceMappingURL=dev---Swdzhz.js.map