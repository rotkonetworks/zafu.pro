import { B as mergeProps, Q as untrack, _ as createComponent, w as createRenderEffect } from "./dev-DwVSoUQZ.js";
import { B as setAttributeNS, E as getPropAlias, Q as style, W as spread, b as dynamicProperty, d as SVGElements, f as SVGNamespace, h as classList, i as DelegatedEvents, k as insert, l as Properties, n as ChildProperties, p as addEventListener, t as Aliases, y as delegateEvents, z as setAttribute } from "./dev---Swdzhz.js";

//#region node_modules/.pnpm/solid-js@1.9.14/node_modules/solid-js/html/dist/html.js
var tagRE = /(?:<!--[\S\s]*?-->|<(?:"[^"]*"['"]*|'[^']*'['"]*|[^'">])+>)/g;
...
function createHTML(r, { delegateEvents: delegateEvents$1 = true, functionBuilder = (...args) => new Function(...args) } = {}) {
	...
	function createTemplate(statics, opt) {
		...
		const [html$2, code] = parseTemplate(parse(markup), opt.funcBuilder), templates = [];
